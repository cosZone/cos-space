...
export default function PostItemCard({ className, data }: PostItemCardProps) {
  return (
    <Card className={twMerge('flex gap-2 transition-shadow hover:shadow-card', className)}>
      <div className="h-40 w-[calc(50%-2rem)] overflow-hidden rounded-lg clip-path-post-img-left">
        <motion.img
      ...
      <div className="flex w-1/2 flex-col gap-2 px-4 pb-2 pt-4">
