...
export const MParagraph: FC<DetailedHTMLProps<HTMLAttributes<HTMLParagraphElement>, HTMLParagraphElement>> = (props) => {
...
const isLink = (child: any) => {
  if (typeof child === 'object') {
    if ((child as any)?.props?.href && (child as any)?.props?.children?.length === 1) {
      return true;
    }
  }
  return false;
